...
public class LoginService {
    ...
    public TokenResponse createToken(TokenRequest tokenRequest) {
        UserDetails userDetails = userAuthenticator.authenticate(tokenRequest.getUsername(), tokenRequest.getPassword())
    ...
    public boolean isAdmin(String authorizationHeader) {
        ...
        return memberId.filter(userAuthenticator::isAdmin).isPresent();
    }
