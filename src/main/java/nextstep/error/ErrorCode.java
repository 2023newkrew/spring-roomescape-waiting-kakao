...
public enum ErrorCode {
    ...
    INVALID_RESERVATION(HttpStatus.INTERNAL_SERVER_ERROR, "유효하지 않은 예약입니다. 관리자에게 문의해주세요."),
    ...
    INVALID_RESERVATION_WAITING(HttpStatus.INTERNAL_SERVER_ERROR, "유효하지 않은 예약 대기입니다. 관리자에게 문의해주세요."),
    ...
    INVALID_SCHEDULE(HttpStatus.INTERNAL_SERVER_ERROR, "유효하지 않은 스케줄입니다. 관리자에게 문의해주세요."),
    ...
    INVALID_THEME(HttpStatus.INTERNAL_SERVER_ERROR, "유효하지 않은 테마입니다. 관리자에게 문의해주세요."),
    ...
    INVALID_REVENUE(HttpStatus.INTERNAL_SERVER_ERROR, "유효하지 않은 매출 이력입니다. 관리자에게 문의해주세요.");
