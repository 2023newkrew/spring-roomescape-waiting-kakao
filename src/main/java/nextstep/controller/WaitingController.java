...
public class WaitingController {
    ...
    @GetMapping("/mine")
    public ResponseEntity waitingListCurrentUser(@LoginMember UserDetails userDetails) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity waitingRemove(@LoginMember UserDetails userDetails,
                                        @PathVariable Long id) {
        waitingService.removeWaiting(userDetails, id);
