...
public class ReservationController {
    ...
    public ResponseEntity<Reservation> createReservation(@LoginUser LoginMember member, @RequestBody ReservationRequest reservationRequest) {
    ...
    public ResponseEntity<List<MyReservationResponse>> readMyReservations(@LoginUser LoginMember member) {
        List<MyReservationResponse> results = reservationService.findAllByMemberId(member.getId());
        return ResponseEntity.ok().body(results);
    }

    @DeleteMapping("/reservations/{id}")
    public ResponseEntity<Void> deleteReservation(@LoginUser LoginMember member, @PathVariable Long id) {
