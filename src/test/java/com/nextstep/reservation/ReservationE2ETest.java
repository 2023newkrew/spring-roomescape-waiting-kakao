package com.nextstep.reservation;

import com.nextstep.AbstractE2ETest;
...
class ReservationE2ETest extends AbstractE2ETest {
    ...
    void show() {
        ...
        List<ReservationEntity> reservations = response.jsonPath().getList(".", ReservationEntity.class);
